<template>
   <div class="scene-header" style="display: flex;align-items: center;justify-content: center;background-size: cover;"  :style="{background:'url('+imgUrl+')'} ">
            ...
            <div style="display:flex;justify-content: left;">
                ...
                <div class="logo-container" style="">
                    <div style="display:flex;align-items: center;">
                        ...
                        <div style="padding-left:.2em;color:white">
                            <p>中央气象台</p>
                            <p>沙尘预报评估业务系统</p>
                        </div>
                    </div>
                ...
                <!--头部菜单-->
                <div class="topMenu" v-if="knowledgeDbMenu.length>0" style="margin: 0 auto;">
                    <ul class="menu-list-container">
                        <li  :class="{'active':categoryName==ele.categoryName}"  class="menu-list-item" v-for="(ele,key) in knowledgeDbMenu" :key="key" >
                            <p :class="{'active':categoryName==ele.categoryName}"  style="color:white;border:none;line-height:30px" @click="getMenuItem">{{ele.categoryName}}</p>
                        </li>
                    </ul>
                </div>
            </div>
...
export default {
    ...
    data() {
        return{
            ...
            categoryName:'影响评估',
            imgUrl:'../../../../html/static/img/universe_wallpaper.jpg',
